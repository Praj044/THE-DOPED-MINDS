...
def train_model(data_dir, num_epochs=5, batch_size=32, learning_rate=0.001,
                 output_path="best_sem_model.pth", seed=42):
    set_seed(seed)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Train the SEM defect classifier.")
    parser.add_argument("--data_dir", type=str, required=True,
                         help="Path to the SEM image-folder dataset (root/<class>/*.png)")
    parser.add_argument("--epochs", type=int, default=5, help="Number of epochs to train")
    parser.add_argument("--batch_size", type=int, default=32, help="Batch size")
    parser.add_argument("--lr", type=float, default=0.001, help="Learning rate")
    parser.add_argument("--output", type=str, default="best_sem_model.pth", help="Where to save the best checkpoint")
